import 'package:bankui/card.dart';
import 'package:bankui/transaction.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Color.fromARGB(255, 0, 152, 223),
        elevation: 0,
                                ...
                                Container(
                                  ...
                                  child: const CircleAvatar(
                                    ...
                                    backgroundImage: NetworkImage(
                                        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzg3p-urPjmnsE_bdLVl6Se7kDIpifOIlqgg&usqp=CAU'),
                                  ),
                                ),
                                const SizedBox(
                                  height: 30,
